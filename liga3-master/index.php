...
<?php
	...
	//Reto
	//Agregar el campo "fecha_nacimiento" al formulario de insertar y validar que solo inserte si es mayor de edad.
 // Cargamos LIGA3
 ...
 if (isset($_SERVER['HTTP_X_REQUESTED_WITH'])) {
  ...
  HTML::cabeceras(array('title'      =>'Pruebas LIGA 3',
			...
			'style'      =>'label { width:100px; }'
					'js' =>array('js/jquery-1.3.1.min.js', 'js/jquery.liga-1.3.1.min.js' , 'js/codigo.js'
			)
		  );
